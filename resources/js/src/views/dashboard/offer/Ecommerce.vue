<template>
  <section id="dashboard-ecommerce">
    ...
    <b-row class="match-height">
      <b-col lg="6">
        <affiliate-company-table :table-data="data" />
      </b-col>
        <!-- Lender Overview-->
        <b-col lg="6">
            <lender-company-table :table-data="data" />
        </b-col>
...
import ApexLineAreaChart from "../../charts-and-maps/charts/apex-chart/ApexLineAreaChart";
