...
<script>
    ...
    import useTierInvoicesList from './useTierInvoiceList'
    ...
    export default {
        ...
        setup() {
            ...
            const tierInvoiceData = ref(null)
            ...
            store.dispatch('app-invoice/fetchTierInvoices', { id: router.currentRoute.params.id })
                .then(response => {
                    // console.log(response.data.invoices)
                    tierInvoiceData.value = response.data.invoices })
                .catch(error => {
                    console.log(error)
                    if (error.response.status === 404) {
                        tierInvoiceData.value = undefined
                    }
                })
