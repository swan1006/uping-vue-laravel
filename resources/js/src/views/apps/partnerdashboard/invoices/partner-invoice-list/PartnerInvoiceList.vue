...
<script>
    ...
    import usePartnerInvoicesList from './usePartnerInvoiceList'
    ...
    export default {
        ...
        setup() {
            ...
            const partnerInvoiceData = ref(null)
            ...
            store.dispatch('app-invoice/fetchPartnerInvoices', { id: router.currentRoute.params.id })
                .then(response => {
                    // console.log(response.data.invoices)
                    partnerInvoiceData.value = response.data.invoices })
                .catch(error => {
                    console.log(error)
