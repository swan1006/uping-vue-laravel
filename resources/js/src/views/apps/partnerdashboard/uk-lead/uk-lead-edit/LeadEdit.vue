...
import buyerStoreModule from '../LeadStoreModule'
import BuyerEditTabAccount from './LeadEditTabAccount.vue'
import BuyerEditTabInformation from './LeadEditTabInformation.vue'
import BuyerEditTabSocial from './LeadEditTabSocial.vue'
